...
public class UserController {
    ...
    public ResponseEntity<FollowingDto> findFollowersByUser(
        ...
        return new ResponseEntity<>(us.getSellersByUser(userId, UserOrderTypeEnum.valueOf(order.toUpperCase())), HttpStatus.OK);
    }
    ...
    public ResponseEntity<FollowersDto> findFollowingsByUser(
        ...
        return new ResponseEntity<>(us.getUsersBySeller(userId, UserOrderTypeEnum.valueOf(order.toUpperCase())), HttpStatus.OK);
    }
