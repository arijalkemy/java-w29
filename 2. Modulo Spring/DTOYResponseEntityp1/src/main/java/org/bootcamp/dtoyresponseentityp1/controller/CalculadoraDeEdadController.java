package org.bootcamp.dtoyresponseentityp1.controller;

import org.bootcamp.dtoyresponseentityp1.model.Persona;
import org.bootcamp.dtoyresponseentityp1.service.CalculadoraDeEdadService;
...
public class CalculadoraDeEdadController {
    ...
    public ResponseEntity<List<Persona>> buscarPersonaPorFechaDeNacimiento(@RequestBody Persona persona) {
        return ResponseEntity.ok(calculadoraDeEdadService.buscarPersonas(persona.fechaDeNacimiento()));
    }

    @GetMapping("/personas")
    public ResponseEntity<List<Persona>> getTodasLasPersonas() {
        return ResponseEntity.ok(calculadoraDeEdadService.getTodasLasPersonas());
    }
}