...
public class ExceptionController {
    ...
    public ResponseEntity<?> idAlreadyInUseException(IdAlreadyInUseException e){
        ExceptionDto exceptionDto = new ExceptionDto(e.getMessage());
        return new ResponseEntity<>(exceptionDto, HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(InvalidVehicleDataException.class)
    public ResponseEntity<?> invalidVehicleDataException(InvalidVehicleDataException e){
        ExceptionDto exceptionDto = new ExceptionDto(e.getMessage());
        return new ResponseEntity<>(exceptionDto, HttpStatus.BAD_REQUEST);
    }
