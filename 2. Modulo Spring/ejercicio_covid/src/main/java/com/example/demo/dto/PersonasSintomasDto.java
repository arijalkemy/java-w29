...
public class PersonasSintomasDto {
    ...
    public PersonasSintomasDto() {
    }

    public PersonasSintomasDto(Long id, String nombre, String apellido, Integer edad, List<Sintomas> sintomasasociados) {
        this.id = id;
        this.nombre = nombre;
