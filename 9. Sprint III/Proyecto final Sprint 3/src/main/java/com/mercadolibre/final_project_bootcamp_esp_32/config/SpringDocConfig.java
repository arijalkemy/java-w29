...
import static com.mercadolibre.final_project_bootcamp_esp_32.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.final_project_bootcamp_esp_32.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("glandoni")
                .email("guido.landoni@mercadolibre.com"));
