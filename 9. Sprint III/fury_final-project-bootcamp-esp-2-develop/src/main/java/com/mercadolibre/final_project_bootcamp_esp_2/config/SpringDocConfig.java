...
import static com.mercadolibre.final_project_bootcamp_esp_2.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.final_project_bootcamp_esp_2.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("mmallol")
                .email("martinfederico.mallol@mercadolibre.com"));
