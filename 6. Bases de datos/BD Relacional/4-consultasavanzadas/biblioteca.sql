...
SELECT * FROM autor WHERE nacionalidad LIKE 'Franc%' OR nacionalidad = 'Italiana';
...
SELECT au.nombre FROM autor NATURAL JOIN libroautor NATURAL JOIN libro where titulo = 'El Universo: Guía de viaje';
...
SELECT titulo FROM libro NATURAL JOIN libroautor NATURAL JOIN autor WHERE nombre = 'J.K. Rowling';
