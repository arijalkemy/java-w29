...
public class ProductsController {
  ...
  public ResponseEntity<?> newPromoPublication(@Valid @RequestBody CreatePromoProductPostRequestDTO publicationDTO){
  ...
  public ResponseEntity<?> newPublication(@Valid @RequestBody CreateProductPostRequestDTO publicationDTO){
