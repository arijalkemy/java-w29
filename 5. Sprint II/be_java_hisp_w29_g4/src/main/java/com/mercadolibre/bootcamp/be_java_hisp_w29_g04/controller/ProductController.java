...
public class ProductController {
    ...
    @PostMapping("/post")
    public ResponseEntity<MessageDto> createPost(@Valid @RequestBody PostDto post){
        return new ResponseEntity<>(postService.createPost(post), HttpStatus.OK);
    }

    @PostMapping("/promo-post")
    public ResponseEntity<MessageDto> createPromoPost(@Valid @RequestBody PromoPostDto post){
    ...
    public ResponseEntity<PostsBySellersFollowedDto> getPostsOfFollowedSeller(
        ...
        return ResponseEntity.ok(postService.getPostsOfFollowedSeller(userId, postService.getPostOrderType(order)));
    }
