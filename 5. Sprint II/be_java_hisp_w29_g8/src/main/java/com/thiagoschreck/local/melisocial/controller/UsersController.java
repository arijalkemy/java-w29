...
public class UsersController {
    ...
    public ResponseEntity<ClientDTO> unfollowSeller(@PathVariable Integer userId,
    ...
    @PostMapping("/clients")
    public ResponseEntity<CreateUserResponseDTO> createClientResponseDTO(
            @Validated @RequestBody CreateUserRequestDTO request) {
        return ResponseEntity.ok(usersService.createClient(request));
    }

    @PostMapping("/sellers")
    public ResponseEntity<CreateUserResponseDTO> createSellerResponseDTO(
            @Validated @RequestBody CreateUserRequestDTO request) {
