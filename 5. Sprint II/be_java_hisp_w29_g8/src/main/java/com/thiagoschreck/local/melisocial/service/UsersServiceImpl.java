...
public class UsersServiceImpl implements IUsersService {
    ...
    public SellerDTO getSellerFollowersByUserId(int userId, String order) {
        ...
        Seller seller = usersRepository.findSellerById(userId, order).orElseThrow(
    ...
    public ClientDTO getClientFollowedSellersByUserId(int userId, String order) {
        ...
        Client client = usersRepository.findClientById(userId, order).orElseThrow(
                () -> new ClientNotFoundException(userId));
        return map(client);
    }
    ...
    public ClientDTO unfollowSeller(Integer userId, Integer userIdToUnfollow) {
        ...
        Seller seller = usersRepository.findSellerById(userIdToUnfollow).orElseThrow(
                () -> new SellerNotFoundException(userIdToUnfollow));
    ...
    public ClientDTO followSeller(Integer userId, Integer userIdToFollow) {
        Client client = usersRepository.findClientById(userId).orElseThrow(ClientNotFoundException::new);
        Seller seller = usersRepository.findSellerById(userIdToFollow).orElseThrow(
                () -> new SellerNotFoundException(userIdToFollow));
        client.getFollowing().stream()
