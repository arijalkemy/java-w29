...
public class ClienteBasic implements ConsultaDeSaldo, PagoDeServicios, RetiroDeEfectivo, Deposito, Transferencia {
    private static final boolean consultaDeSaldo = true;
    private static final boolean pagoDeServicios = true;
    private static final boolean retiroDeEfectivo = true;
    private static final boolean deposito = false;
    private static final boolean transferencia = false;
