...
import integrador_p2_e2.Socorristas.SocorristaAuto;
import integrador_p2_e2.Socorristas.SocorristaMoto;
...
public class Carrera {
    ...
    public void darDeAltaAuto(Double velocidad, Double aceleracion, Double anguloDeGiro, String patente) {
        if (vehiculos.size() <= this.cantidadDeVehiculos)
            vehiculos.add(new Autos(velocidad, aceleracion, anguloDeGiro, patente));
    }

    public void darDeAltaMoto(Double velocidad, Double aceleracion, Double anguloDeGiro, String patente) {
        if (vehiculos.size() <= this.cantidadDeVehiculos)
            vehiculos.add(new Motos(velocidad, aceleracion, anguloDeGiro, patente));
    }
