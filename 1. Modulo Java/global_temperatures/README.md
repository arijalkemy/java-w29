...
Sabiendo que cada índice de fila representa a una ciudad. _Se necesita conocer la mayor y la menor temperatura entre todas las ciudades; al mismo tiempo se deberá especificar el nombre de la ciudad_. Por ejemplo, la menor temperatura la tuvo Tokio, con -10 º C.