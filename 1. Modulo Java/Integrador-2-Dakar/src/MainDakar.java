public class MainDakar {
    public static void main(String[] args) {
        ...
        Auto auto = new Auto(100.0, 200.0, 1.5, "A");
        Moto moto = new Moto(100.0, 200.0, 1.5, "B");

        System.out.println(carrera.getGanadador().getPatente());

        carrera.socorrerAuto(String.valueOf(auto));
        carrera.socorrerMoto(String.valueOf(moto));
    }
}
