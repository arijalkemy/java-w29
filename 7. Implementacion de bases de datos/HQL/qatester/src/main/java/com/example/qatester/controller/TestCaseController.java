...
import com.example.qatester.service.ITesterService;
...
public class TestCaseController {
    ...
    @PostMapping("/newtester")
    public ResponseEntity<MessageDto> postTester(
            @RequestBody @Valid TesterDto testerDto
    ) {
        return ResponseEntity.ok(this.iTesterService.addTester(testerDto));
    }
}
